    ...
    <section className="flexCenter flex-col">
      <div className='border-2 border-red-500 padding-container max-container w-full pb-24'>
        ...
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          ...
          when there is no internet connection in the field. Invite your friends,
          relatives and friends to have fun in the wilderness through the valley and
      ...
      <div className='flexCenter max-container relative w-full border-2 border-blue-500'>
        <Image
          ...
          width={1440}
          height={580}
          className='w-full object-cover object-center 2xl:rounded-5l'
          />
      </div>
